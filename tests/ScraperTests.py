...
class ScraperTests(unittest.TestCase):
    ...
    def test_scraper_naverbook_meta_class(self):
        for review in scraper.get_reviews(isbn13=9788932919126, bookstores=Naverbook, count=1):
    ...
    def test_scraper_kyobo_meta_class(self):
        for review in scraper.get_reviews(isbn13=9788932919126, bookstores=Kyobo, count=1):
    ...
    def test_scraper_multiple_bookstore(self):
        for review in scraper.get_reviews(isbn13=9788932919126, bookstores=(Naverbook, Kyobo), count=1):
